...
<div class="content remove_pad" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="fresh">Mô Tả</span></h2>
			...
			<div class="detail_holder">
				...
				<div class="detail_desc">
					...
					<form class="" method="post" action="detail.php">
						...
						<p><span class="bold_desc">Loại:</span> <?php echo $cat; ?></p>
						<p><span class="bold_desc price">Giá:</span><span id="price"><?php echo $price; ?>VND</span></p>
						<div class="form_group">
							
							<p><span class="bold_desc">Số Lượng:</span></p>
						...
						<p><span class="bold_desc">Tổng:</span><span id="total_price"><?php echo $price; ?>VND</span></p>
						
						<div class="form_group">
							<input type="hidden" name="fid" value="<?php echo $id; ?>">
							<input type="submit" name="submit" class="submit add_order" value="Thêm Vào Giỏ Hàng" />
