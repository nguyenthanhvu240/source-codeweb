...
<div class="parallax" onclick="remove_class()">
	...
	<div class="parallax_head">
		...
		<h2>Xin Chào Quí Khách</h2>
		<h3>Chúng tôi rất vinh hạnh khi được phục vụ quí khách.</h3>
...
<div class="content" onclick="remove_class()">
	...
	<a href="reservation.php" class="submit">Đặt Bàn Ngay</a>
...
<div class="content remove_pad" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="fresh">Khám Phá Những Món Ngon Mới Ngay</span></h2>
