...
<div class="parallax" onclick="remove_class()">
	...
	<div class="parallax_head">
		...
		<h2>Không Gian Riêng</h2>
		<h3>Chỉ Giành Cho Bạn</h3>
...
<div class="content" onclick="remove_class()">
	...
	<div class="inner_content">
		...
		<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="hr_book_form">
			...
			<h2 class="form_head"><span class="book_icon">Đặt Bàn Ngay</span></h2>
			<p class="form_slg">CHÚNG TÔI CUNG CẤP CHO BẠN CÁC DỊCH VỤ TỐT NHẤT CHỈ DÀNH CHO BẠN</p>
			...
			<div class="left">
				...
				<div class="form_group">
					...
					<input type="number" placeholder="" min="1" name="guest" id="guest" required>
				...
				<div class="form_group">
					...
					<input type="date" name="date_res" placeholder="" required>
			...
			<div class="left">
				...
				<div class="form_group">
                    ...
                    <label>Yêu Cầu Của Bạn: <small><b>(Chẳng hạn như vị trí,cách sắp xếp bàn...)</b></small></label>
					<textarea name="suggestions" placeholder="Yêu Cầu Của Bạn" required></textarea>
