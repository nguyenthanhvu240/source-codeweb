...
<div class="content remove_pad" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="s_summary">Đặt Hàng Thành Công</span></h2>
		...
		<div class="order_holder">
			...
			<strong><p class="summary_p">Chúng tôi sẽ đảm bảo rằng đơn đặt hàng của bạn được giao trong thời gian nhanh nhất và chúng tôi hy vọng rằng bạn tiếp tục ủng hộ chúng tôi. Xin lưu ý rằng là bạn phải cung cấp chính xác thông tin để chung tôi có thể phục vụ cho bạn một cách tốt nhất và nhanh nhất. Xin chân thành cám ơn quí khách.</p></strong>
		</div>
